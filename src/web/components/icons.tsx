...
export function WhatsAppIcon() {
	return (
		<svg width="18" height="18" viewBox="0 0 32 32" fill="currentColor" aria-hidden>
			<path d="M19.1 17.5c-.3-.2-1.7-.8-2-.9-.3-.1-.5-.2-.7.2-.2.3-.8.9-1 .1-.2.1-.4.1-.7 0-.3-.2-1.2-.4-2.3-1.4-.8-.7-1.4-1.6-1.5-1.8-.2-.3 0-.4.1-.6.1-.1.3-.3.4-.5.1-.1.1-.3.2-.5s0-.4 0-.6c-.1-.2-.7-1.6-.9-2.2-.2-.6-.5-.5-.7-.5h-.6c-.2 0-.6.1-.8.4-.3.3-1 1-1 2.5s1 2.9 1.2 3.1c.2.2 2 3 4.8 4.2.7.3 1.3.5 1.7.6.7.2 1.4.2 2 .1.6-.1 1.7-.7 1.9-1.4.2-.6.2-1.2.1-1.3-.1-.1-.3-.2-.6-.3z" />
			<path d="M16 3C8.8 3 3 8.7 3 15.8c0 2.5.7 4.9 2.1 6.9L3 29l6.5-2.1c1.9 1 4.1 1.6 6.5 1.6 7.2 0 13-5.7 13-12.8S23.2 3 16 3zm0 23.2c-2.1 0-4.2-.6-6-1.7l-.4-.2-3.8 1.2 1.2-3.7-.3-.4c-1.2-1.8-1.9-3.9-1.9-6.1C4.8 9.9 9.7 5 16 5s11.2 4.9 11.2 10.8S22.2 26.2 16 26.2z" />
		</svg>
	);
}
